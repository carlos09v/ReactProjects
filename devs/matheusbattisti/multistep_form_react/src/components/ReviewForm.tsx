  ...
  return (
    <div className="review-form">
      <div className="form-control score-container">
        ...
        <label className="radio-container">
          <input type="radio" value="very_satisfied" name="review" required checked={data.review === 'veru_satisfied'} onChange={e => updateFieldHandler('review', e.target.value)} />
          <BsFillEmojiHeartEyesFill />
